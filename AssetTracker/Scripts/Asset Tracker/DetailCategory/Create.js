...
$(document).ready(function () {
    ...
    var generalCategoryId, categoryId, subCategoryId;
    ...
    function checkNameAvailability() {
        $.ajax({
            url: "/DetailCategory/IsNameAvailable",
            data: { detailCategoryName: detailCategoryNameValue, subCategoryId: subCategoryId },
            method: "POST",
            success: function (result) {
                if (result !== true) {
                    track = false;
    ...
    function checkCodeAvailability() {
        $.ajax({
            url: "/DetailCategory/IsCodeAvailable",
            data: { detailCategoryCode: detailCategoryCodeValue, subCategoryId: subCategoryId },
            method: "POST",
            success: function (result) {
                if (result !== true) {
                    track = false;
