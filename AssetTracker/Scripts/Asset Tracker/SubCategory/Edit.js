...
$(document).ready(function () {
    ...
    function checkNameAvailability() {
        $.ajax({
            url: "/SubCategory/IsNameAvailableWithId",
            data: { subCategoryName: subCategoryNameValue, subCategoryId: subCategoryId, categoryId: categoryId },
            method: "POST",
            success: function (result) {
                if (result !== true) {
                    track = false;
    ...
    function checkCodeAvailability() {
        $.ajax({
            url: "/SubCategory/IsCodeAvailableWithId",
            data: { subCategoryCode: subCategoryCodeValue, subCategoryId: subCategoryId, categoryId: categoryId },
            method: "POST",
            success: function (result) {
                if (result !== true) {
                    track = false;
