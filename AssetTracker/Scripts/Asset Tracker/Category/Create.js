...
$(document).ready(function () {
    ...
    function checkNameAvailability() {
        $.ajax({
            url: "/Category/IsCategoryNameAvailable",
            data: { generalCategoryId: generalCategoryId, categoryName: categoryNameValue },
            method: "POST",
    ...
    function checkCodeAvailability() {
        $.ajax({
            url: "/Category/IsCategoryCodeAvailable",
            data: { generalCategoryId: generalCategoryId, categoryCode: categoryCodeValue },
            method: "POST",
            success: (function (result) {
